...
using ci8  = NARNUM::CBinNum<char,NARNUM::CObfBitset>;
using cu8  = NARNUM::CBinNum<unsigned char,NARNUM::CObfBitset>;
using ci16 = NARNUM::CBinNum<short,NARNUM::CObfBitset>;
using cu16 = NARNUM::CBinNum<unsigned short,NARNUM::CObfBitset>;
using ci32 = NARNUM::CBinNum<int,NARNUM::CObfBitset>;
using cu32 = NARNUM::CBinNum<unsigned int,NARNUM::CObfBitset>;
using ci64 = NARNUM::CBinNum<long long,NARNUM::CObfBitset>;
using cu64 = NARNUM::CBinNum<unsigned long long,NARNUM::CObfBitset>;
using cptr = NARNUM::CBinNum<unsigned long,NARNUM::CObfBitset>;     // Same as size_t
